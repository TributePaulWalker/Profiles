...
/*
[Script]
iOS_Weather_AQI_Standard = type=http-response,pattern=^https:\/\/weather-data\.apple\.com\/v1\/weather\/[\w-]+\/([0-9]+\.[0-9]+)\/([0-9]+\.[0-9]+)\?,requires-body=1,max-size=0,script-path=Surge_IOS_Weather_AQI_Standard.js
